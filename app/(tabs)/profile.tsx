  ...
  return (
    <Container>
      ...
      <View className="flex flex-row items-center mb-5 gap-7">
        <View>
          <Image source={{ uri: defaultProfileImageUri }} className="w-32 h-32 rounded-full" />
        </View>
        <View>
      ...
      <View className="flex flex-col gap-1 bg-[#ECECEC] border border-[#dddddd] rounded-xl">
        <TouchableOpacity onPress={() => router.push("../profile/pedidos")} className="px-5 py-6 rounded-xl">
        ...
        <TouchableOpacity onPress={handleLogout} className="px-5 py-6 rounded-xl">
          <View className="flex flex-row items-center gap-3">
